  ...
  return (
    <>
        ...
        <div className="container w-3/4  bg-[#D3D3D3] mx-auto flex px-5 py-24 flex-col items-center md:flex-1 ">
             <h1 className='mb-4 text-[black] text-2xl self-center font-semibold   '>SIGN IN</h1>
            <form className='w-3/4 lg:flex-grow  md:flex-1 flex flex-col  md:text-left items-center md:justify-center md:mx-3'>
              ...
              <button  onClick={PostData}  type="submit" className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 transform active:scale-75 transition-transform">Login</button>
            </form>
            <p className="my-4">Already have account? <Link className='text-[#e96868]' to="/">Login here</Link></p>
        </div>
      </section>
